      ...
      <div>
        ...
        <QuestionAnswer question="Quelles méthodes utilisez-vous pour éliminer les nids de guêpes et de frelons ?">
          <p>
            ...
            de pesticides appropriés, l'enlèvement mécanique des nids, et
            d'autres techniques adaptées à chaque situation. Rassurez-vous cela
            n'est dangereux ni pour vous ni pour vos animaux domestiques.
          </p>
        </QuestionAnswer>
        ...
        <QuestionAnswer question="Puis-je rester sur place lors de l’intervention ?">
          <p>
            Dans la plupart des cas, il n'est pas nécessaire de quitter la
            maison pendant le traitement, mais cela dépend du type d'insectes et
            des produits utilisés. Nous vous informerons des précautions
            nécessaires.
          </p>
        </QuestionAnswer>
      </div>
